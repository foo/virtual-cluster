...
There are not capacity constraints on links, and no extra, idling nodes. \maciek{no idle nodes were introduced earlier.}
...
\maciek{Picture of how chunks are used twice?}
...
\item We construct $n$ chunk types named $u_1, \ldots, u_n$.
  Intuitively, we want some $n$ nodes to process one of these chunks and $3$ chunks from \TripleGadget
