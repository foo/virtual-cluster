...
No cycles in optimal flow because $T$ is a tree and every cycle would have to go back through the same edges both ways. Therefore we don't need to go back.
