...
We set the number of nodes to $\Vms = \clauses \cdot \variables$ \maciek{TODO: check again, it might not be good number. Right number is number of literals in the formula. We might want to decide to solve 3SAT to express this value easier}.
