...
\maciek{
I would like to propose that in summary we take each of MA/NI/FP/RS/BW and say how it affects hardness:
}

\begin{itemize}
\item BW does not matter
\item RS is crucial to NP-completeness
\item MA does not matter unless paired with MA and RS
\item FP simplifies to 0 cost, with MA or NI we have to use more sophisticated techniques, with RS and (MA or NI) we have NP-completeness
\item NI is trivial without FP and can be precomputed
\end{itemize}
