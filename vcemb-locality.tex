...
Using the fact that $\sum_e(\deg(e)-1) = 3\cdot t - 3\cdot k = \Vms - k$, by pidgeon-hole principle we conclude that indeed spawning $\Vms-n+i$ nodes in the \CoverSubtree{} results in at least $3\cdot i$ long matches.
...
\begin{proof}
  ...
  In total, the cost incurred is $8\cdot n + 6\cdot (\Vms - k) = \Thr$.
