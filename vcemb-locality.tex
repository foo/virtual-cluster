...
$bw(T_{\ell},x)$:
$$bw(T_l,x)=  \CostTrans \cdot |x - |\ChunkCount(T_{\ell})|| + \CostCom \cdot (\Vms - x) \cdot x$$

\maciek{I spreaded the bw definition over whole line as it was breaking before.}
...
Now \maciek{I suggest removing the word ``now''}, consider any pair of nodes communicating over the
