...
\begin{proof}
\item Exactly $n$ {\TripleGadgets} are active (\ref{np-balance}).
...
\begin{enumerate}
\item the network is reduced network from previous proof (no \UnqSubtree, no unique chunks in Elements Subtree)
