...
This paper investigated data locality aware algorithms which exploit two 
fundamental
...
many problem instances can actually be solved in polynomial time, while other 
instances are computationally hard
even in uncapacitated networks.
We have also shown that several embedding problems are NP-hard already in two- 
and three-level trees
