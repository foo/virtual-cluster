...
\begin{enumerate}
  \item $\mathbb{U}$ -- set of elements of universe
  \item $A, B, C$ -- disjoint sets that covers $\mathbb{U}$
  \item $n := |A|$
  \item $e$ -- an element of universe ($e \in A \cup B \cup C$)
  \item $T$ -- set of triples
  \item $t$ -- a triple ($t \in T$)
  \item $T_e$ -- set of triples that contain element $e$
  \item $\deg(e) := |T(e)|$
  \item $E(t)$ -- elements of triple $t$
\end{enumerate}
