...
\item no feasible solution places one or two nodes in a Triple Gadget. We use the same lower-bound of the cost argument of other nodes as in previous proof.
\end{enumerate}
