...
\begin{lemma}
  Assume we have a $\RS(2)+\FP+\CC+\BW$ instance $I$ constructed in
  the described way from $\TDPM$ instance.  Assume that no chunk
  transportation is allowed, and $\CostCom = 1$.
...
\begin{lemma}
  ...
  Then we have that the number of nodes spawned in {\TripleGadget} of
