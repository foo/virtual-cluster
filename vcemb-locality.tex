...
\begin{lemma}
Given a $\CC+\MA$ problem instance and a subtree rooted at vertex $u$ containing 
$x$
...
\begin{corollary}
Given a $\CC+\MA$ problem instance, all local assignments have the same costs. 
\end{corollary}


\begin{lemma}
Given a $\CC+\MA$ problem instance, a feasible assignment $\VmChunkAssignment$ 
