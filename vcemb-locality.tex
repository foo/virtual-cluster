...
\begin{enumerate}
  \item Figure how chunk replicas are placed twice
\end{enumerate}
...
\begin{enumerate}
  ...
  \item $\deg(e) := |T(e)|$
  \item $\lbrace t_X, t_Y, t_Z \rbrace$ -- elements of triple $t$
...
We construct three types of chunks. First type correspond to covers of elements by triples, with two replicas each. Other two types are chunk types with one replica only, distinguished by a different role in the construction.
