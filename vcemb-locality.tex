...
the left subtree of $T'$ and $r$ nodes in right subtree of
...
Therefore, we have:
\begin{eqnarray*}
f(T', x) &=& \min_{\ell \in \{0, \ldots, x\}}  f(T'_{\ell}, {\ell}) + f(T'_r, x - {\ell}) \\
&&+ \emph{AccessCost}(T'_{\ell},{\ell},T'_r,x-l)\\ &&+ \emph{InterconnectCost}({\ell},x-{\ell})\\
\end{eqnarray*}
...
\begin{figure}
\includegraphics[width=\columnwidth]{figs/venn_full}
\caption{Summary of results. As this paper only presented algorithms (approaches indicated in the same
