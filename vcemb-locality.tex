...
Next, we show how to precisely control the number of nodes in the constructed subtree. First, we observe that in every feasible solution we have exactly $|U|$ nodes spawned in {\UnqSubtree\} (no chunk transportation is allowed). Furthermore we can reason about the number of nodes spawned in the rest of the tree:
...
\begin{lemma}
  ...
  \begin{enumerate}
    ...
    \item The number of nodes spawned in {\TripleGadget} of element $e$ is $\deg(e)-1$
  \end{enumerate}
\end{lemma}
