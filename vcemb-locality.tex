...
\begin{proof}
  ...
  Let's take any feasible solution $\Solution$ to the instance
  described above. We call the {\TripleGadget} \textit{active}, if we
  have a node spawned in any leaf of it. We refer to the active nodes
  in {\TripleGadgets} by \ActiveNodes. We construct 3D-matching
  solution $M_S$ from triples that correspond to active
  \TripleGadgets.
