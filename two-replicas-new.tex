...
We construct the tree of the following structure (see Figure~\ref{fig:red-ma}):
...
\begin{enumerate}
  ...
  {\UnqGadgets} far from leaves of other \UnqGadgets. We refer to the collection of \UnqGadgets as the unique comb.
...
\begin{proof}
  ...
  {\TripleGadgets} the \ActiveNode. We construct a~$\TDPM$ solution from
