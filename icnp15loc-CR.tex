...
up to $4$ for virtual machines each. 
...
multiple dimensions of flexibility in terms of chunk assignment and node placement, \carlo{on the scale of a modern datacenter}
many problems can be solved \carlo{efficiently}. However, we have also
...
\newblock In {\em Proc. ACM SIGCOMM}, pages 63--74, 2008.

\bibitem{nodb}
I.~Alagiannis, R.~Borovica, M.~Branco, S.~Idreos, and A.~Ailamaki.
\newblock Nodb: Efficient query execution on raw data files.
\newblock In {\em Proc. ACM SIGMOD}, pages 241--252, 2012.

\bibitem{local-schedule-1}
G.~Ananthanarayanan, S.~Agarwal, S.~Kandula, A.~Greenberg, I.~Stoica,
  D.~Harlan, and E.~Harris.
\newblock Scarlett: Coping with skewed content popularity in mapreduce
  clusters.
\newblock In {\em Proc. EuroSys}, pages 287--300, 2011.

\bibitem{oktopus}
H.~Ballani, P.~Costa, T.~Karagiannis, and A.~Rowstron.
\newblock Towards predictable datacenter networks.
\newblock In {\em Proc. ACM SIGCOMM}, 2011.

\bibitem{scope}
R.~Chaiken, B.~Jenkins, P.-A. Larson, B.~Ramsey, D.~Shakib, S.~Weaver, and
  J.~Zhou.
\newblock Scope: Easy and efficient parallel processing of massive data sets.
\newblock {\em Proc. VLDB Endow.}, 1(2), 2008.

\bibitem{endpoint}
M.~Chowdhury, S.~Kandula, and I.~Stoica.
\newblock Leveraging endpoint flexibility in data-intensive clusters.
\newblock In {\em Proc. SIGCOMM}, pages 231--242, 2013.

\bibitem{orchestra}
M.~Chowdhury, M.~Zaharia, J.~Ma, M.~I. Jordan, and I.~Stoica.
\newblock {Managing Data Transfers in Computer Clusters with Orchestra}.
\newblock In {\em Proc. ACM SIGCOMM}, 2011.

\bibitem{boutaba-survey}
N.~M.~K. Chowdhury and R.~Boutaba.
\newblock A survey of network virtualization.
\newblock {\em Comput. Netw.}, 54(5):862--876, 2010.

\bibitem{3dmatch}
P.~Crescenzi, V.~Kann, M.~Halldorsson, M.~Karpinski, and G.~Woeginger.
\newblock Maximum 3-dimensional matching.
\newblock {\em A Compendium of NP Optimization Problems}, 2000.

\bibitem{mapreduce}
J.~Dean and S.~Ghemawat.
\newblock Mapreduce: Simplified data processing on large clusters.
\newblock In {\em Proc. USENIX OSDI}, pages 137--150, 2004.

\bibitem{mla}
N.~R. Devanur, S.~A. Khot, R.~Saket, and N.~K. Vishnoi.
\newblock Integrality gaps for sparsest cut and minimum linear arrangement
  problems.
\newblock In {\em Proc. ACM STOC}, 2006.

\bibitem{mla-survey}
J.~D\'{\i}az, J.~Petit, and M.~Serna.
\newblock A survey of graph layout problems.
\newblock {\em ACM Comput. Surv.}, 34(3):313--356, 2002.

\bibitem{scale-match}
R.~Duan and H.-H. Su.
\newblock A scaling algorithm for maximum weight matching in bipartite graphs.
\newblock In {\em Proc. 23rd Annual ACM-SIAM Symposium on Discrete Algorithms
  (SODA)}, pages 1413--1424, 2012.

\bibitem{fischer-survey}
A.~Fischer, J.~Botero, M.~Beck, H.~DeMeer, and X.~Hesselbach.
\newblock Virtual network embedding: A survey.
\newblock 2013.

\bibitem{gabow_scaling_algorithm}
H.~Gabow.
\newblock A scaling algorithm for weighted matching on general graphs.
\newblock In {\em Proc. IEEE FOCS}, 1985.

\bibitem{google-fs}
S.~Ghemawat, H.~Gobioff, and S.-T. Leung.
\newblock The google file system.
\newblock In {\em Proc. ACM SOSP}, pages 29--43, 2003.

\bibitem{mincostmaxflow-1}
A.~V. Goldberg and R.~E. Tarjan.
\newblock Finding minimum-cost circulations by canceling negative cycles.
\newblock {\em J. ACM}, 36(4):873--886, 1989.

\bibitem{Goyal2008}
N.~Goyal, N.~Olver, and F.~B. Shepherd.
\newblock {The VPN conjecture is true}.
\newblock {\em Proc. ACM STOC}, 2008.
...
\newblock In {\em Proc. ACM SIGCOMM}, 2009.

\bibitem{secondnet}
C.~Guo, G.~Lu, H.~J. Wang, S.~Yang, C.~Kong, P.~Sun, W.~Wu, and Y.~Zhang.
\newblock {SecondNet}: {A} data center network virtualization architecture with
  bandwidth guarantees.
\newblock In {\em Proc. 6th CoNEXT}, 2010.

\bibitem{gupta2001provisioning}
A.~Gupta, J.~Kleinberg, A.~Kumar, R.~Rastogi, and B.~Yener.
\newblock {Provisioning a virtual private network}.
\newblock In {\em Proc. ACM STOC}, New York, New York, USA, 2001.

\bibitem{local-schedule-2}
M.~Isard, V.~Prabhakaran, J.~Currey, U.~Wieder, K.~Talwar, and A.~Goldberg.
\newblock Quincy: Fair scheduling for distributed computing clusters.
\newblock In {\em Proc. ACM SOSP}, pages 261--276, 2009.

\bibitem{successive_shortest_path_complexity}
Z.~Kiraly and P.~Kovacs.
\newblock Efficient implementations of minimum-cost flow algorithms.
\newblock In {\em {ArXiv} Technical Report 1207.6381}, 2012.

\bibitem{talk-about}
J.~C. Mogul and L.~Popa.
\newblock What we talk about when we talk about cloud network performance.
\newblock {\em ACM SIGCOMM CCR}, 2012.

\newpage

\bibitem{faircloud}
L.~Popa, A.~Krishnamurthy, S.~Ratnasamy, and I.~Stoica.
\newblock Faircloud: Sharing the network in cloud computing.
\newblock In {\em Proc. HotNets-X}, 2011.

\bibitem{elasticswitch}
L.~Popa, P.~Yalagandula, S.~Banerjee, J.~C. Mogul, Y.~Turner, and J.~R. Santos.
\newblock Elasticswitch: Practical work-conserving bandwidth guarantees for
  cloud computing.
\newblock In {\em Proc. ACM SIGCOMM}, pages 351--362, 2013.

\bibitem{drl}
B.~Raghavan, K.~Vishwanath, S.~Ramabhadran, K.~Yocum, and A.~C. Snoeren.
\newblock Cloud control with distributed rate limiting.
\newblock In {\em Proc. SIGCOMM}, 2007.

\bibitem{gatekeeper}
H.~Rodrigues, J.~R. Santos, Y.~Turner, P.~Soares, and D.~Guedes.
\newblock Gatekeeper: Supporting bandwidth guarantees for multi-tenant
  datacenter networks.
\newblock In {\em Proc. 3rd Conference on I/O Virtualization (WIOV)}, 2011.

\bibitem{ccr15emb}
M.~Rost, C.~Fuerst, and S.~Schmid.
\newblock Beyond the stars: Revisiting virtual cluster embeddings.
\newblock In {\em Proc. ACM SIGCOMM Computer Communication Review (CCR)}, 2015.

\bibitem{seawall}
A.~Shieh, S.~Kandula, A.~Greenberg, and C.~Kim.
\newblock Seawall: Performance isolation for cloud datacenter networks.
\newblock In {\em Proc. USENIX HotCloud}, 2010.

\bibitem{hdfs}
K.~Shvachko, H.~Kuang, S.~Radia, and R.~Chansler.
\newblock The hadoop distributed file system.
\newblock In {\em Proc. IEEE 26th Symposium on Mass Storage Systems and
  Technologies (MSST)}, pages 1--10, 2010.

\bibitem{mincostmaxflow-2}
E.~Tardos.
\newblock A strongly polynomial minimum cost circulation algorithm.
\newblock {\em Combinatorica}, 5(3):247--255, July 1985.
...
\newblock {\em ACM SIGCOMM Computer Communication Review (CCR)}, 2012.

\bibitem{shark}
R.~S. Xin, J.~Rosen, M.~Zaharia, M.~J. Franklin, S.~Shenker, and I.~Stoica.
\newblock Shark: Sql and rich analytics at scale.
\newblock In {\em Proce. ACM SIGMOD}, pages 13--24, 2013.

\bibitem{local-schedule-3}
M.~Zaharia, D.~Borthakur, J.~Sen~Sarma, K.~Elmeleegy, S.~Shenker, and
  I.~Stoica.
\newblock Delay scheduling: A simple technique for achieving locality and
  fairness in cluster scheduling.
\newblock In {\em Proc. EuroSys}, pages 265--278, 2010.

\bibitem{amazonbw}
{Measuring EC2 system performance}.
\newblock \url{http://goo.gl/V5zhEd}.
...
%  2 \cdot \clauses - 2), $$
%
%  then for each $i\leq \variables$: $a_i = \clauses$ and for
...
\begin{lemma}[Extended Bandwidth Lemma]\label{lem:bandwidth-lemma-extended}
%\maciek{this lemma might be expressed more clearly if we use two
%  sequences instead of one - now $a_1, \ldots, a_{\variables}$
%  correspond to number of VMs in variable gadgets and remaining of the
%  sequence corresponds to number of VMs in clause gadgets.}
...
$$ \forall_{i\leq\clauses}:~~ a_i \cdot (\clauses \cdot \variables + 2 \cdot \clauses - a_i) \leq 2 \cdot (\clauses \cdot \variables -
  ...
  then for each $i\leq \variables$: $b_i = \clauses$ and for
