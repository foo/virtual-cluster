...
This research is in part supported by Polish National Science Centre grant DEC-2013/09/B/ST6/01538, 
the EU project Bigfoot FP7-ICT-317858,
by Aalborg University's PreLytics projecs as well as by the German BMBF Software Campus grant 01IS12056.
...
\bibitem{icnp15loc}
C.~Fuerst, M.~Pacut, P.~Costa, and S.~Schmid.
\newblock How hard can it be? understanding the complexity of replica aware
  virtual cluster embeddings.
\newblock In {\em Proc. 23rd IEEE International Conference on Network Protocols
  (ICNP)}, 2015.

\bibitem{infocom16}
C.~Fuerst, S.~Schmid, L.~Suresh, and P.~Costa.
\newblock Kraken: Online and elastic resource reservations for multi-tenant
  datacenters.
\newblock In {\em Proc. 35th IEEE Conference on Computer Communications
  (INFOCOM)}, 2016.
