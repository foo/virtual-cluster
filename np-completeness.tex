...
constraints ($\FP+\MA+\CC+\BW$), and an algorithm 
...
substrate networks (namely two-level trees, 
or datacenter \emph{pods}~\cite{fattree}). 
...
hypergraphs. We will refer to this problem by $\TDM$, and review it in the following.
