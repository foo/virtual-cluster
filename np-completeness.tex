...
top level, we set the same bandwidth to: $v \cdot (v -
...
mixed between $positive(v)$ and $negative(v)$ subtrees. Todo: prove it
more formally in model without bandwidth using better definition of $C$.
