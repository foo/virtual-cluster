...
\begin{enumerate}
\item balanced rooted tree $T$ 
\item edge capacities $bw(e)$
...
We set number of virtual machines to $v = cl(\Psi) \cdot var(\Psi)$.
...
To finish our construction, we need to set value of constant $Th$. 
